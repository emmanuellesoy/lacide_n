...
<!--  script para diferenciar por Ip -->
<script type="text/javascript">
...
function geolocate(timezone, cityPrecision, objectVar) {
  ...
  var url = "http://" + domain + "/v3/" + api + "/?key=ac40d4c20b257828ed278b6b318481a671c09e8bfa3a14f262522023fd3be661&format=json" + "&callback=" + objectVar + ".setGeoCookie";
  var geodata;
  var callbackFunc;
  var JSON = JSON || {};
